  ...
  return (
    <div className="p-6 md:p-12 max-w-4xl mx-auto space-y-8">
      ...
      <section>
        ...
        <Card>
          <CardContent className="p-4">
            ...
            <p className="text-sm text-gray-600">Apr 2020 – Present | Recruiter - Biometric Requirements</p>
        ...
        <Card className="mt-4">
          <CardContent className="p-4">
            ...
            <p className="text-sm text-gray-600">Apr 2019 – Mar 2020 | HR Recruiter</p>
            <ul className="list-disc ml-5 mt-2 text-gray-800">
        ...
        <Card className="mt-4">
          <CardContent className="p-4">
            ...
            <p className="text-sm text-gray-600">Nov 2017 – Apr 2019 | Senior Technical Recruiter</p>
            <ul className="list-disc ml-5 mt-2 text-gray-800">
      ...
      <section>
        ...
        <p className="text-gray-800">Bachelor's Degree in Mechanical Engineering, Kurukshetra University (2011 – 2015)</p>
      </section>
